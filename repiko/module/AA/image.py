...
def AA2img(AAtext:str):
    ...
    draw = ImageDraw.Draw(Image.new("RGB", imsize, (244,244,244)))
    draw.font = font
    # AAsize=font.getsize_multiline(AAtext,spacing=2)
    AAbbox = draw.multiline_textbbox((0,0), AAtext, font=font, spacing=2)
    AAsize = (AAbbox[2] - AAbbox[0], AAbbox[3] - AAbbox[1])
